...
class Generator_BG(nn.Module):
    def __init__(self, z_dim, label_channel=0, num_res_blocks=2, num_res_blocks_fg=0, num_res_blocks_bg=0):
        ...
        nn.init.xavier_uniform_(self.cond_64.weight.data, 1.)
        ...
        nn.init.xavier_uniform_(self.final_bg.weight.data, 1.)
...
class Generator_FG(nn.Module):
    ...
    def __init__(self, z_dim, label_channel=0, num_res_blocks=2):
        ...
        nn.init.xavier_uniform_(self.recon_64.weight.data, 1.)
        nn.init.xavier_uniform_(self.recon_32.weight.data, 1.)     
        nn.init.xavier_uniform_(self.recon_16.weight.data, 1.)
