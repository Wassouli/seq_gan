...
class CocoData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(num_object): 
            ...
            torch.add(seg_masks[self.category.index(instance['category_id']),:,:],  mask, out=seg_masks[self.category.index(instance['category_id']),:,:])
...
if __name__ == '__main__':
    ...
    dataset = CocoData(root = '/content/drive/MyDrive/train2014/train2014/',
                            annFile = '/content/instances_train2014.json',
