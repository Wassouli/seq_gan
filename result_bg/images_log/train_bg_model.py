...
def main():
    ...
    parser.add_argument('--train_imgs_path', type=str, default='/content/drive/MyDrive/train2014/train2014/', help='Path to training images')
    parser.add_argument('--train_annotation_path', type=str, default='/content/instances_train2014.json', help='Path to annotation file, .json file')
  ...
  #print(G_bg)
    ...
    for epoch in range(opt.train_epoch):
        ...
        while num_iter < len(train_loader):  
            ...
            #Branch-similar loss
            branch_sim_loss = mse_loss(torch.mul(G_result,(1-y_reduced) ), torch.mul(G_bg1,(1-y_reduced))  )
